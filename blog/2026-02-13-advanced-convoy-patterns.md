...
The following chart shows the typical distribution of convoy patterns across successful Gas Town deployments.

```mermaid
pie title Convoy Pattern Usage Distribution
    "Fan-Out / Fan-In" : 45
    "Dependency Chain" : 25
    "Cross-Rig Convoy" : 15
    "Rolling Convoy" : 10
...
- [Git Workflows for Multi-Agent Teams](/blog/git-workflows-multi-agent) — Git branching and merging strategies for parallel convoy work
