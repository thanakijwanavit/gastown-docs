...
This is the exact pattern Gas Town is built for — independent parallel work with a final coordination step. The code-review formula is just a convoy where every bead is a review leg and the synthesis is the convoy's completion handler.
