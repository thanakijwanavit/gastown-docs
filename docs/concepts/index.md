...
These concepts share several common design principles:
...
- **Crash-safe** -- State is designed to survive crashes, restarts, compaction, and handoffs between sessions
